            ...
            <table class="w-full whitespace-no-wrap">
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <td class="px-4 py-3 text-sm"><div>
                        ...
                        <td class="px-4 py-3">
                            <!-- Nút chỉnh sửa -->
                            <a href="{{ URL::to('detail-product/'. $product->product_id) }}" class="text-primary" title="Chỉnh sửa">
                                <i class="fas fa-eye"></i>
                            </a>
                            <!-- Nút xóa -->
                            <a href="{{ URL::to('delete-product/'. $product->product_id) }}" class="text-danger ml-2" title="Xóa">
