...
<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Menu /</span> Thêm mới</h4>
  ...
  <div class="card mb-4">
    ...
    <div class="card-body">
      <form action="{{ URL::to('Admin/save-menu') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <a href="{{ URL::to('Admin/all-menu') }}" class="btn btn-secondary">Quay lại</a>
      </form>
    </div>
  </div>
</div>
